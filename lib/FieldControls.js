...
import { Link, Switch, Radio, FormControlLabel, RadioGroup, Checkbox, FormHelperText, InputLabel, Select, MenuItem, Button, } from "@material-ui/core";
...
export var FileButtonControl = function (_a) {
    var onChange = _a.onChange, required = _a.required, className = _a.className, helperText = _a.helperText, control = _a.control, error = _a.error, name = _a.name, _b = _a.label, label = _b === void 0 ? "Upload File" : _b, defaultValue = _a.defaultValue, rest = __rest(_a, ["onChange", "required", "className", "helperText", "control", "error", "name", "label", "defaultValue"]);
...
//# sourceMappingURL=FieldControls.js.map